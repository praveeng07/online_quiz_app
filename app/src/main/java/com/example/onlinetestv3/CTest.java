...
public class CTest extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_c_test, container, false);
        List<Question> questionList = dbHelper.getQuestionsByCategory("objective_c_questions.csv");
