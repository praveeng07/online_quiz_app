...
public class CppTest extends Fragment {
    ...
    public CppTest(Context context) {
        // Required empty public constructor
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_cpp_test, container, false);

        List<Question> questionList = dbHelper.getQuestionsByCategory("python_questions.csv");
